...
lime checkmark is a "clean sweep" that reads as a completed cleanup, and the sparkle
...
the brand mark, the primary focused action, and completed states; it should never be used
